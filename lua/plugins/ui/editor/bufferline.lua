    ...
    config = function()
        require("bufferline").setup({
            options = {
                ...
                tab_size = 16,
                enforce_regular_tabs = false,   -- tabs will be prevented from extending beyond
                -- the tab size and all tabs will be the same length
                -- if set to `true`, it will disable the ability to deduplicate buffers.
