...
----"%#HighlightGroupName#Your text here"

----vim.opt.winbar = "%{%v:lua.require('config.ui.winbar').render()%}"
...
vim.api.nvim_set_hl(0, "WinBar", { fg = "#ffaa00", bg = "NONE", bold = false })
vim.api.nvim_set_hl(0, "WinBarNC", { fg = "#888888", bg = "NONE" })
